...
export const metadata: Metadata = {
  ...
  title: "MeinAppNest — Self-hosted Apps, live in Minuten",
  ...
  openGraph: { title: "MeinAppNest", description: "Self-hosted Apps, live in Minuten — auf deiner eigenen Subdomain.", images: ["/og.png"], type: "website", locale: "de_DE" },
